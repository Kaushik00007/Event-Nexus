      ...
      <div className="w-full h-full flex items-start justify-center p-6 relative z-10 pt-[5vh] lg:pt-[10vh] overflow-hidden">
        ...
        >
          ...
          <div className="mb-6 text-center lg:text-left">
            <h2 className="text-2xl font-bold tracking-tight mb-2 text-white">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <label className="flex flex-1 items-center cursor-pointer group">
                <span className="ml-2.5 text-xs text-gray-400/90 group-hover:text-gray-300 transition-colors font-light">Remember me</span>
              </label>
              <a href="#" className="text-xs font-medium text-purple-400/90 hover:text-purple-300 hover:drop-shadow-[0_0_8px_rgba(167,139,250,0.5)] transition-all">
                Forgot password?
              </a>
            </div>
