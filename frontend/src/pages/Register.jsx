      ...
      <div className="w-full flex items-center justify-center p-6 sm:p-12 relative z-10 py-12">
        ...
        >
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-bold tracking-tight mb-3 text-white">Create an account</h2>
            <p className="text-gray-400/80 text-base">Join the community of event enthusiasts</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            <div>
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500/80 w-5 h-5 transition-colors group-focus-within:text-purple-400" />
                <input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div>
              ...
              <div className="relative group">
                <Building className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500/80 w-5 h-5 transition-colors group-focus-within:text-purple-400" />
                <input
                  id="college"
                  name="college"
                  type="text"
              ...
              {formData.password && (
                <div className="mt-3">
                  <div className="flex items-center space-x-3">
                    <div className="flex-1 h-1.5 bg-[#0F1629] rounded-full overflow-hidden border border-white/5 relative">
                      <div
                        className={`absolute left-0 top-0 h-full ${pwStrength.color} transition-all duration-300 shadow-[0_0_10px_currentColor] opacity-80`}
                        style={{ width: `${(pwStrength.strength + 1) * 25}%` }}
                      ></div>
                    </div>
                    <span className="text-[10px] text-gray-400/80 font-bold uppercase tracking-wider w-16 text-right">
                      {pwStrength.text}
                    </span>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                {formData.confirmPassword && formData.password === formData.confirmPassword && (
                  ...
                  >
                    <CheckCircle className="w-5 h-5 text-green-500/80 drop-shadow-[0_0_8px_rgba(34,197,94,0.5)]" />
                  </motion.div>
                )}
              </div>
            </div>
            ...
            <div className="flex items-start cursor-pointer group pt-2">
              <div className="flex items-center h-5">
                <input
                  ...
                  type="checkbox"
                  required
                  className="h-4 w-4 rounded bg-[#0F1629]/80 border-white/10 text-purple-500 focus:ring-purple-500/50 focus:ring-offset-0 mt-0.5 shrink-0 transition-colors"
                />
              </div>
              <label htmlFor="terms" className="ml-3 text-sm text-gray-400/90 group-hover:text-gray-300 transition-colors leading-relaxed font-light">
                I agree to the{' '}
