...
const Register = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col lg:grid lg:grid-cols-[1.2fr_1fr] bg-[#0B0F1A] text-white overflow-hidden relative font-sans">
      ...
      <div className="hidden lg:flex relative flex-col justify-between p-12 xl:p-20 border-r border-white/5 h-full overflow-hidden">
      ...
      <div className="w-full h-full flex items-center justify-center p-4 lg:p-6 relative z-10 overflow-hidden">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label htmlFor="name" className="block text-[11px] font-medium text-gray-300 mb-1">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="college" className="block text-[11px] font-medium text-gray-300 mb-1">
                College / University
              </label>
              <div className="relative group">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[11px] font-medium text-gray-300 mb-1">
                Confirm Password
              </label>
              <div className="relative group">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500/80 w-3.5 h-3.5 transition-colors group-focus-within:text-purple-400" />
            ...
            <div className="flex items-start cursor-pointer group pt-1">
              <div className="flex items-center h-4">
                <input
                  ...
                  type="checkbox"
                  required
                  className="h-3 w-3 rounded bg-[#0F1629]/80 border-white/10 text-purple-500 focus:ring-purple-500/50 focus:ring-offset-0 mt-0.5 shrink-0 transition-colors"
                />
              </div>
